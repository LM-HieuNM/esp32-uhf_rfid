...
static void wifi_app_soft_ap_config(void)
{
	...
	char ap_ssid[32];
	sprintf(ap_ssid, "%s_%02X%02X", WIFI_AP_SSID, mac_address[4], mac_address[5]);
...
//						if(app_nvs_load_socket_creds() == true){
//							ESP_LOGI(TAG, "app_nvs_load_socket_creds done");
//						}
//						else{
//							ESP_LOGI(TAG, "app_nvs_load_socket_creds fail");
//						}
